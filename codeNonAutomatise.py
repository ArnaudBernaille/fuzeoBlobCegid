...
Ce code est le meme que les autres mais sans es fonctions python pour pouvoir le lancer automatiquement tous les X.
C'est juste pour pouvoir le déclencher à la main.
